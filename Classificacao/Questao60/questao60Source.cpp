...
int main ()
{
	...
	Mat tabela (classes, 4, CV_32FC1);

	switch (tipo)
	{
		case 1:
			Knn_1 (tabela, matrizConfusao, normalizado, lable, teste,teste_lable,treino, treino_lable, atributos,tamanho_teste,tamanho_treino,classes,num_linhas,opcao, vet_classe, vet_classe_treino);
		break;
		case 2: 
			k_means (tabela, matrizConfusao, teste, treino, teste_lable, treino_lable, classes, num_linhas,  tamanho_teste, tamanho_treino, vet_classe, vet_classe_treino, atributos, lable);
		break;
		case 3:
			KNN (tabela, matrizConfusao, treino, treino_lable, teste, teste_lable, tamanho_teste, classes);
		break;
		case 4:
			MLP_Opencv (tabela, matrizConfusao, normalizado,lable,teste,teste_lable,treino,treino_lable, config, atributos, tamanho_teste, tamanho_treino, classes, num_linhas, opcao, vet_classe, vet_classe_treino);
		break;
		case 5:
			SVM_funcao (tabela, matrizConfusao, classes, treino, treino_lable, teste, teste_lable, tamanho_teste);
		break;
		case 6:
			bayes (tabela, matrizConfusao, classes, treino, treino_lable, teste, teste_lable, tamanho_teste);
		break;
		case 7:
			printf ("Quantos vizinhos: ");
			scanf ("%d\n", &N);
			Knn_N(tabela, matrizConfusao,normalizado,lable,teste,teste_lable,treino,treino_lable,atributos,tamanho_teste,tamanho_treino,classes,num_linhas,opcao,N,vet_classe,vet_classe_treino);
		break;
	}
